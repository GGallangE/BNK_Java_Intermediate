...
public class AppMain {
    ...
    public static void main(String[] args) {
        ...
        // 사용자 주문 목록
        List<Order> orderList = shopping.getOrders();
        shopping.addCustomerOrders(customer1.getUid(), orderList);
        ...
        // 사용자 주문 목록 출력
        HashMap<String, List<Order>> customerOrders = shopping.getCustomerOrders();
